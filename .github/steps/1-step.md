...
1. In the **Code** tab of your repository, create a new branch named `welcome-workflow`.
   ...
   <img width="400" alt="create branch screenshot" src="https://github.com/wenjunshao/hello-github-actions-835eaa08-d365-45f7-b447-7c9166f77f3f/blob/main/.github/images/create-branch-screenshot.png?raw=true" />
